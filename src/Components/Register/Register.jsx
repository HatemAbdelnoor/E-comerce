...
async   function handleRegister(values){
  ...
  <form  onSubmit={formik.handleSubmit}>
    ...
    <div className='w-75 mx-auto py-4' >
      ...
      <input type='text' onBlur={formik.handleSubmit} className='form-control' id='name' name='name' placeholder='' onChange={formik.handleChange} value={formik.values.name} />
      {formik.errors.name && formik.touched.name ? <div className='alert alert-danger'>{formik.errors.name} </div>:null }
      <label htmlFor='phone' >phone</label>
      <input type='text  onBlur={formik.handleSubmit}' className='form-control' id='phone' placeholder='' name='phone' onChange={formik.handleChange} value={formik.values.phone} />
      ...
      <input type='password'  onBlur={formik.handleSubmit} className='form-control' id='rePassword' name='rePassword' onChange={formik.handleChange} value={formik.values.rePassword} />
