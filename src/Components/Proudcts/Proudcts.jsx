...
export default function Products() {
  ...
  async function getProducts(limit,sort,page) {   
    let {data}= await axios.get(`https://route-ecommerce.onrender.com/api/v1/products?limit=${limit}&sort=${sort}&page=${page}`)
  ...
  <div className="col-md-12 ">
    <div className="card">
      <div className="card-header">
        ...
        <ul>
            <li> <input type="number" placeholder='proudct limit' onKeyUp={ getProducts()} /> </li>

        </ul>
      </div>
      <div className="card-body row col-md-12 d-block d-flex flex-wrap justify-content-center">
